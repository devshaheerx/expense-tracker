...
const AuthLayout = ({ title, subtitle, children, footer }) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[rgb(var(--color-bg))] px-3 sm:px-4">
      <div className="w-full max-w-sm sm:max-w-md ledger-card p-6 sm:p-8">
        <h1 className="font-display text-2xl sm:text-3xl font-semibold mb-1 text-[rgb(var(--color-ink))]">
          {title}
        </h1>
        {subtitle && (
